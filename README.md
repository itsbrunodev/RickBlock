...
**Step 2:** If you're using a <a href="https://chromiumchecker.com/" target="_blank">Chromium</a> based browser then go to `chrome://extensions` and enable `Developer Mode` in the top right corner.<br/>
